...
if strcmp(method, 'all')
    ...
    evaluate_method('Pinv', traj_pinv, landmarks_pinv, odom, gt_traj, gt_landmarks, true);
    evaluate_method('Chol1', traj_chol1, landmarks_chol1, odom, gt_traj, gt_landmarks, true);
    evaluate_method('Chol2', traj_chol2, landmarks_chol2, odom, gt_traj, gt_landmarks, true);
    evaluate_method('QR1', traj_qr1, landmarks_qr1, odom, gt_traj, gt_landmarks, true);
